...
export const DatePicker = () => {
    ...
    return(
        <div className={`flex py-4 px-2 flex-col items-center gap-2 rounded border-2 border-slate-700 bg-black ${ !isOpen && "hover:bg-slate-800"} w-full`} onClick={handleOpen}>
